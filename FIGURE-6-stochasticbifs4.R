...
# This code uses base-code.R
# to create Figure 6 of the publication
...
load.it=FALSE;load.file="FIGURE-6-stochasticbifs4.Rdata"
...
pdf("FIGURE-6-stochasticbifs4.pdf",width = 6,height=4)
...
dev.off()
#save.image("FIGURE-6-stochasticbifs4.Rdata")